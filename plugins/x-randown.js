...
conn.sendMessage(m.chat, { text: xdnot.risa_not_1, mentions: [m.sender] }, {quoted: {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "51957041866-1613049930@g.us" } : {})},message: {"videoMessage": { "title":null, "h": `UwU`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': `Sinsentido :v`, 'jpegThumbnail': null}}} })
setTimeout( () => {
